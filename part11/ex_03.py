"""
A function named best_results(results: list) which takes a list of ExamResult objects as its argument and return a new list containing only the best result from each ExamResult object. 
"""
