# MOOC Python Programming - University of Helsinki

Este repositório contém as minhas soluções para os exercícios do curso **Python Programming MOOC**, oferecido pelo Departamento de Ciência da Computação da **Universidade de Helsinki**.
...
- **Lógica e Fluxo:** Loops (`while`, `for`), fatiamento de strings (*slicing*), condicionais complexas.
...
```text
├── README.md
├── part01/            # Conceitos básicos, variáveis e condicionais
├── part02/            # Loops e loops aninhados
├── part03/            # Funções e strings
└── part04/            # Listas, dicionários e algoritmos (ex: Grade Statistics)
